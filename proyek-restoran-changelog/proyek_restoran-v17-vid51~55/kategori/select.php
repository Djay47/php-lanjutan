...
<!-- Tombol Tambah -->
<a type="button" class="btn btn-primary btn-sm m-1 py-0" href="?dir=kategori&file=insert">Tambah</a>
		...
		<?php foreach ($kategori as $ktgr) : ?>
			<tr>
				...
				<td class="text-center">
					<a href="?dir=kategori&file=update&id=<?= $ktgr["idkategori"] ?>" class="btn btn-outline-info btn-sm m-0 py-0">
						Perbarui
					</a>
				</td>
				<td class="text-center">
					<a href="?dir=kategori&file=confirm-delete&id=<?= $ktgr["idkategori"] ?>" class="btn btn-outline-danger btn-sm m-0 py-0">
						Hapus
					</a>
				</td>
			</tr>
