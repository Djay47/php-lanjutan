...
<!-- Tombol Tambah -->
<a type="button" class="btn btn-primary btn-sm m-1 py-0" href="?dir=menu&file=insert">Tambah</a>
...
<table class="table-sm">
	<form action="" method="post" class="my-3 mx-1">
		<tr>
			...
			<td>
				<button type="submit" name="pilih" class="btn btn-outline-secondary btn-sm">Pilih</button>
			</td>
		</tr>
	</form>
</table>
		...
		<?php foreach ($menu as $mn) : ?>
			<tr>
				...
				<td class="text-center">
					<a href="?dir=menu&file=update&id=<?= $mn["idmenu"] ?>" class="btn btn-outline-info btn-sm m-0 py-0">
						Perbarui
					</a>
				</td>
				<td class="text-center">
					<a href="?dir=menu&file=confirm-delete&id=<?= $mn["idmenu"] ?>" class="btn btn-outline-danger btn-sm m-0 py-0">
						Hapus
					</a>
				</td>
			</tr>
