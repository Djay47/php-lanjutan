	...
	<body>
		<div class="container">
			...
			<div class="row mb-5 ">
				...
				<div class="col-md-10">
					<div class="float-end my-3 ">
						<a href="#" class="btn btn-outline-dark btn-sm py-0">Pelanggan</a>
						<a href="#" class="btn btn-outline-dark btn-sm py-0 ms-2">Daftar</a>
						<a href="#" class="btn btn-outline-primary btn-sm py-0 ms-2">Login</a>
						<a href="#" class="btn btn-outline-danger btn-sm py-0 ms-2">Logout</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-2 px-0 border-end border-5">
