...
<!-- Table Data kategori -->
<table class="table table-bordered w-25 m-1">
	<thead>
		<tr>
	...
	<tbody>
		...
		<?php foreach ($kategori as $ktgr) : ?>
			<tr>
				<td><?= $nomor++ . "."; ?></td>
				<td><?= $ktgr["kategori"]; ?></td>
				<td class="text-center"><a href="?dir=kategori&file=confirm-delete&id=<?= $ktgr["idkategori"] ?>">Hapus</a></td>
				<td class="text-center"><a href="?dir=kategori&file=update&id=<?= $ktgr["idkategori"] ?>">Perbarui</a></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
