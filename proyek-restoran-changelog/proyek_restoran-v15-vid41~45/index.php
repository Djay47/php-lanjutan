					...
					<div class="float-end my-3 ">
						...
						<?php else : ?>
							<?php if ( isset( $_SESSION["keranjang"] ) ) : ?>
								<a href="?dir=home&file=keranjang" class="btn btn-outline-dark btn-sm py-0">Keranjang</a>
							<?php endif; ?>
							<a href="#" class="btn btn-outline-dark btn-sm py-0 ms-2"><?= strtoupper($_SESSION["pelanggan"]) ?></a>
